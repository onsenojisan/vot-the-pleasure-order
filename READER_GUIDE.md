...
5. [Structural Appendix: Omega-C-Act Coordinate Model](STRUCTURAL_APPENDIX_OMEGA_C_ACT.md) for the post-v1.3 coordinate clarification.
...
## If You Are Reviewing The Theory
...
1. [Current Status](CURRENT_STATUS.md)
2. [Zenodo Records](ZENODO_RECORDS.md)
3. [Claim Boundary](CLAIM_BOUNDARY.md)
4. [Empirical Readiness](EMPIRICAL_READINESS.md)

Current evidence should be read as bounded:

- O/M/A evidence is D2/D2+ proxy-level only.
- L4 evidence is rule-conditional structural-proxy evidence only.
- older Omega-facing empirical materials are historical, methodological, or exploratory unless explicitly reauthorized.
- no public record currently establishes direct Omega measurement, direct pleasure/suffering measurement, direct O/M/A validation, causality, or theory confirmation.

## If You Are A Potential Data Collaborator
...
## If You Are Citing The Project

Read:

1. [Zenodo Records](ZENODO_RECORDS.md)
2. [Claim Boundary](CLAIM_BOUNDARY.md)
3. [Current Status](CURRENT_STATUS.md)

Do not cite any record as proving VOT, proving The Pleasure Order, directly measuring Omega, or validating O/M/A unless a future record explicitly states that claim and passes the relevant boundary conditions.
...
| [Structural Appendix: Omega-C-Act Coordinate Model](STRUCTURAL_APPENDIX_OMEGA_C_ACT.md) | Post-v1.3 structural clarification; not empirical validation. |
...
| [Restart Status](RESTART_STATUS.md) | Historical restart summary retained for context. |
...
No routing document upgrades the evidence level of any archived record.
